...
[orders](#orders): Returns orders information with specified user and conditions<br/>
...
## orders
  ...
  Returns orders information with specified user and conditions
...
* **Method:**
  ...
  `GET`
*  **Arguments**
	  - __maker__: address of maker
	  - __filter__: all/open/history
	  - __offset__: starting position
	  - __limit__: specified number
	 
* **Returns**
			Array of specified user's order(s) 
...
* **Sample Call:**
  ...
  ```javascript
    $.ajax({
      url: "/v0/pdex/orders?maker=0x783a242Da80a6142f6B48BdBD4C1b9C6E1E0042F&filter=all&offset=0&limit=20",
      dataType: "json",
      type : "GET",
      success : function(r) {
        console.log(r);
